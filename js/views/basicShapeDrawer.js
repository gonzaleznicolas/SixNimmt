...
{
	static drawCardShape(ctx, x, y, width, height, radius)
	{
			if (width > 15)
			{
				ctx.beginPath();
	...
	static drawDetailedCowShape(ctx, centreX, centreY, cowWidth, cowHeight)
	{
	...
	static drawsimplifiedCowShape(ctx, centreX, centreY, cowWidth, cowHeight)
	{
			const designConstH = 9;	// dont change
			const designConstW = 10;	// dont change
